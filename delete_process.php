...
if (mysql_query($query)) {
	$query="DELETE FROM tblproduct_stocks WHERE product_key='$id'";
	mysql_query($query);
	do
	{
	...
	$activity_details = "Deleted ".$brand_name." in Product List.";
...
{
	$activity_date = date("Y/m/d");
	$activity_details = "Failed to Delete ".$brand_name." in Product List due to an Error.";
	$query="INSERT INTO tblactivity_log (activity,activity_id,activity_date) VALUES ('$activity_details','$activity_id','$activity_date')";
	mysql_query($query);
