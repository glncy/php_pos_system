...
while ($row=mysql_fetch_array($get)) {
	...
	$output.= "<tr><td>".$row_2['barcode']." ".$row_2['brand_name']." ".$row_2['generic_name']."</td><td>".$row['qty']."</td><td>&#8369;".$row_2['selling_price']."</td><td align='center'><button onclick='delOrder(\"".$id."\")' type='button'>X</button></td></tr>";
}
